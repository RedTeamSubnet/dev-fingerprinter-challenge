...
import requests
from pydantic import BaseModel, Field, IPvAnyAddress, validate_call, AnyHttpUrl, SecretStr, conint, constr, EmailStr
...
class DFPManager:
    ...
    def update_fingerprint(
        ...
        logger.info(f"Received fingerprint for device {target.ts_name} (order_id: {order_id}, browser: {target.browser}): {payload.fingerprint}")
